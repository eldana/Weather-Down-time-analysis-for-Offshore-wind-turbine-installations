...
\textbf{Methodology --}
A discrete event  simulation model has been developed taking the vessel characteristics, distance matrix, installation methodology and sequence of activities into account . 
...
\textbf{Conclusions --}
This paper give an insight how a simulation weather down time analysis could  improve the decision support system in the offshore wind energy development industry at the planning phase .

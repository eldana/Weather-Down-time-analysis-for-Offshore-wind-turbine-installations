...
\end{enumerate}
Table 1 represents the monthly workability percentages for three different weather scenarios (Best,Average and Worst) where the time window is considered to be 1 hour and the limiting factor (wind speed) is 15 m/s. 

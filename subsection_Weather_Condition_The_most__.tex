...
F(x) = P(X ≤ x) where the right-hand side represents the probability that the random variable X takes on a value less than or equal to x. The quantile function (for example Q80) can be computed by finding the value of x such that F(x)=0.2 .  

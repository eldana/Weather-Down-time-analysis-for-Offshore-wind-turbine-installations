...
\item \textbf{Transportation} : This is the trip back to the port in order to load the remaining turbine components and similar procedure will be followed as the one to the offshore site mentioned in terms of weather time window.
